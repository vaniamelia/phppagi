...
$query=mysqli_query($koneksi, "insert into cuti_karyawan (NIK,nama,jabatan,bagian,mulai_cuti,berakhir_cuti,keterangan,jenis_cuti,sisa_cuti)
value('$NIK','$nama','$jabatan','$bagian','$mulai_cuti','$berakhir_cuti','$keterangan','$jenis_cuti','$sisa_cuti')");
if ($query){
